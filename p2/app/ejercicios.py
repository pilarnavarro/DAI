...
def ordena(matriz,algorithm):
    if algorithm=="burbuja":
        return "La matriz ordenada según el algoritmo de burbuja es:<br/>" + burbuja(matriz)
    elif algorithm=="merge_sort" or algorithm=="merge":
        return "La matriz ordenada según el algoritmo de mezcla es:<br/>" + mergeSort(matriz)
    else:
...
#Input es el archivo de entrada y output el de salida
